...
# Username: heggens             TODO: mogameda
#
# Assignment: A11: PPM
#
...
# Aknowledgments: Dr. Jan Pierce and Scott Heggen
######################################################################
# Usage Instructions:
...
0 0 0 20 20 20 40 40 40 60 60 60 80 80 80 100 100 100 120 120 120 140 140 140'''
    ...
    def PPM_rotateclockwise(self):
        ...
        self.PPM_updatefrompixellist(rotated_pic)
        # This call will update all member attributes appropriately.


    def PPM_make_green(self):
        """
        Colorizes current image to green by using self.pixellist

        :return: None
        """
        newpixellist = self.pixellist
        self.width = len(newpixellist[1])
        self.height = len(newpixellist)
        row = 0
        for rowlist in newpixellist:
            col = 0
